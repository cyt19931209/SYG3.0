    ...
    [DataSeviece requestUrl:get_qiniu_tokenhtml params:params1 success:^(id result) {
        ...
        for (NSInteger i = 0; i <assets.count ; i++) {
            ...
            [manager POST:@"http://up-z2.qiniu.com" parameters:params constructingBodyWithBlock:^(id<AFMultipartFormData> formData) {
                ...
                [_imageStrArr replaceObjectAtIndex:i +item withObject:responseObject[@"result"][@"data"][@"file_name"]];
...
- (void)ExpectedDeliveryTypeNotification:(NSNotification*)noti{
    ...
    _exectdTextField.text = _expectedDic[@"title"];
    ...
    [DataSeviece requestUrl:goods_sharehtml params:params success:^(id result) {
        ...
        if ([result[@"result"][@"code"] isEqualToString:@"1"]) {
            ...
            if (!_PHImageV.hidden) {
                ...
                [params1 setObject:PHDic[@"id"] forKey:@"account_id"];
            ...
            if (!_ADMImageV.hidden) {
                ...
                [params1 setObject:ADMDic[@"id"] forKey:@"account_id"];
            ...
            if (!_WBImageV.hidden) {
                ...
                [params1 setObject:WBDic[@"id"] forKey:@"account_id"];
